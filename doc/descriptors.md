# Support for Output Descriptors in TitaniumCoin Core

Since TitaniumCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `titanium1...` for mainnet or `ttitanium1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing TitaniumCoin Core wallets, a convenience function `combo` is
