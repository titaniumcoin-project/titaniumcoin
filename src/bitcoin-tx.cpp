...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " titaniumcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  titaniumcoin-tx [options] <hex-tx> [commands]  Update hex-encoded titaniumcoin transaction\n" +
            "or:     titaniumcoin-tx [options] -create [commands]   Create hex-encoded titaniumcoin transaction\n" +
            "\n";
