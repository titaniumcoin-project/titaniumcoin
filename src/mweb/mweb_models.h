// Copyright(C) 2011 - 2020 The TitaniumCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef TITANIUMCOIN_MWEB_MODELS_H
#define TITANIUMCOIN_MWEB_MODELS_H
...
#endif // TITANIUMCOIN_MWEB_MODELS_H