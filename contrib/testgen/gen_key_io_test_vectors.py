...
bech32_templates = [
  ...
  ('titanium',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('titanium',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('titanium',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('titanium',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('ttitanium',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ttitanium',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ttitanium',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('ttitanium',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('ttitanium',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ttitanium',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ttitanium',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('ttitanium',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rtitanium',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rtitanium',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rtitanium',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rtitanium', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('ttitanium',   17, 32, Encoding.BECH32M, False, False, False),
  ('rtitanium',  3,  1, Encoding.BECH32M, False, False, False),
  ('titanium',   15, 41, Encoding.BECH32M, False, False, False),
  ('ttitanium',    0, 16, Encoding.BECH32,  False, False, False),
  ('rtitanium',  0, 32, Encoding.BECH32,  True,  False, False),
  ('titanium',    0, 16, Encoding.BECH32,  True,  False, False),
  ('ttitanium',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rtitanium',  0, 20, Encoding.BECH32,  False, False, True),
  ('titanium',    0, 20, Encoding.BECH32M, False, False, False),
  ('ttitanium',    0, 32, Encoding.BECH32M, False, False, False),
  ('rtitanium',  0, 20, Encoding.BECH32M, False, False, False),
  ('titanium',    1, 32, Encoding.BECH32,  False, False, False),
  ('ttitanium',    2, 16, Encoding.BECH32,  False, False, False),
  ('rtitanium', 16, 20, Encoding.BECH32,  False, False, False),
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['titanium', 'ttitanium', 'rtitanium']:
