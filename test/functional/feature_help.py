...
"""Verify that starting titaniumcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start titaniumcoin with -h for help text")
        ...
        self.log.info("Start titaniumcoin with -version for version information")
        ...
        self.log.info("Start titaniumcoind with -fakearg to make sure it does not start")
