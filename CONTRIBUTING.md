Contributing to TitaniumCoin Core
============================

The TitaniumCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the TitaniumCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/titaniumcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to titaniumcoin-qt
...
The following applies to code changes to the TitaniumCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall TitaniumCoin
Network Protocol consensus changes.

Whether a pull request is merged into TitaniumCoin Core rests with the project merge
...
Patches that change TitaniumCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the TitaniumCoin consensus, it must have been
...
The project leader is the release manager for each TitaniumCoin Core release.
